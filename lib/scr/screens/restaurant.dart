              ...
              Stack(
                ...
                borderRadius: BorderRadius.only(
                  ...
                  Positioned.fill(
                      ...
                      child: Align(
                          alignment: Alignment.bottomCenter,
                          child: CustomText(text: "Average Price: \MVR" + restaurantModel.avgPrice.toString(), color: white, size: 18, weight: FontWeight.w300,))),
...
//              open & book section
              Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                      child: FlatButton.icon(onPressed: (){}, icon: Icon(Icons.restaurant_menu), label: CustomText(text: "")))
                ],
              ),
